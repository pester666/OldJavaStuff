...
/**
 *  Basis class for all level elements, implements common behaviour of all
 *  level elements, which is scrolling, drawing... . Specific bahaviour has
...
public class LevelElement
{
	...
	public void paintElement(Graphics g)
	{
		if(inSight)
		{
			g.drawImage(element_image, x_pos_left, y_pos_up, parent);
		}
	}
}