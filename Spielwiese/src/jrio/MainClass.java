...
public class MainClass extends JFrame implements Runnable{
 ...
 // Constants
    ...
    public void init()
    {
            ...
            // set player images
            player.setImages(mario_stop_right, mario_walk_right, mario_jump_right,
                                             mario_stop_left, mario_walk_left, mario_jump_left);
    ...
    private void getImages()
    {
            ...
            mario_stop_right = new ImageIcon("Images/Mario/MarioStandingRight.gif").getImage();
            tracker.addImage(mario_stop_right, 1);

            mario_walk_right = new ImageIcon("Images/Mario/MarioWalkingRight.gif").getImage();
            tracker.addImage(mario_walk_right, 2);

            mario_jump_right = new ImageIcon("Images/Mario/MarioJumpingRight.gif").getImage();
            tracker.addImage(mario_jump_right, 3);

            mario_stop_left = new ImageIcon("Images/Mario/MarioStandingLeft.gif").getImage();
            tracker.addImage(mario_stop_left, 4);

            mario_walk_left = new ImageIcon("Images/Mario/MarioWalkingLeft.gif").getImage();
            tracker.addImage(mario_walk_left, 5);

            mario_jump_left = new ImageIcon("Images/Mario/MarioJumpingLeft.gif").getImage();
