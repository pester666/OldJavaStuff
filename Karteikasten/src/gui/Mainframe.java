...
public class Mainframe implements MainframeSteuerung, KartenSatzModel {
	...
	public void ladenAusführen(){
		if(phasenNrAusgewählt >= 0 && phasenNrAusgewählt <= 4)
			try {
				Mainframe.this.currentKartensatzName = kartensatzAuswahl.getAktuellerKasten();
	...
	public class MenüBearbeitenListener implements ActionListener {
		public void actionPerformed(ActionEvent ev) {
			activateKartenEditorPanel(Mainframe.this.pKartenSpielPanel.getAktuelleKarte());
		}
	}
