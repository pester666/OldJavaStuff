...
/**
 *  Abstract class that implements the most important methods of a
 *  level. It holds an array of level elements and handels the
 *  collision control... . If one uses enemies... this class can
 *  take control over those elements, too.
 */
public abstract class Level
{
	...
	// Color array of background colors for color effect
	...
	public Level(Component parent, String level_name)
	{
		...
		// fetch images
		ground = new ImageIcon("Images/" + level_name + "/ground.gif").getImage();
	}

	// sets background color array
	...
	public void initializeLevel(String [] definitions)
	{
		...
		left_level_border = 0;
		right_level_border = C_Jump.frame_width;
