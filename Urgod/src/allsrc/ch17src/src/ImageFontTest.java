...
import allsrc.ch17src.src.com.brackeen.javagamebook.graphics.ImageFont;
import allsrc.ch17src.src.com.brackeen.javagamebook.test.GameCore;
...
public class ImageFontTest extends GameCore {
    ...
    public void init() {
        ...
        // load image fonts
        bigFont = new ImageFont("src/allsrc/ch17src/fonts/big");
        medFont = new ImageFont("src/allsrc/ch17src/fonts/medium");
