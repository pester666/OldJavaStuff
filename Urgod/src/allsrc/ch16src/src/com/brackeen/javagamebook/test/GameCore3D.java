package allsrc.ch16src.src.com.brackeen.javagamebook.test;
...
import allsrc.ch16src.src.com.brackeen.javagamebook.graphics3D.PolygonRenderer;
import allsrc.ch16src.src.com.brackeen.javagamebook.graphics3D.SolidPolygonRenderer;
...
import allsrc.ch16src.src.com.brackeen.javagamebook.math3D.Polygon3D;
...
import allsrc.ch16src.src.com.brackeen.javagamebook.util.TimeSmoothie;
...
public abstract class GameCore3D extends GameCore {
    ...
    protected GameAction timeSmoothingToggle = new GameAction(
        "timeSmoothingToggle", GameAction.DETECT_INITAL_PRESS_ONLY);
