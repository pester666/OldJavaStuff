package allsrc.ch13src.src.com.brackeen.javagamebook.shooter3D;
...
import allsrc.ch13src.src.com.brackeen.javagamebook.input.GameAction;
import allsrc.ch13src.src.com.brackeen.javagamebook.input.InputManager;
import allsrc.ch13src.src.com.brackeen.javagamebook.math3D.MovingTransform3D;
import allsrc.ch13src.src.com.brackeen.javagamebook.math3D.ObjectLoader;
...
import allsrc.ch13src.src.com.brackeen.javagamebook.test.GameCore3D;
...
public abstract class ShooterCore extends GameCore3D {
    ...
    public void init() {
        ...
        try {
            blastModel = loader.loadObject("src/allsrc/ch13src/images/blast.obj");
            botProjectileModel =
                loader.loadObject("src/allsrc/ch13src/images/botprojectile.obj");
        }
