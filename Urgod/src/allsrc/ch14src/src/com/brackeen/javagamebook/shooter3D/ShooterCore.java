...
public abstract class ShooterCore extends GameCore3D {
    ...
    public void init() {
        ...
        ((CharakterCreator)gameObjectManager.getPlayer()).
    ...
    public void updateWorld(long elapsedTime) {
        ...
        CharakterCreator player = (CharakterCreator)gameObjectManager.getPlayer();
    ...
    public void createPolygons() {
        ...
        gameObjectManager.addPlayer(new CharakterCreator());
